...
trait Dependencies {
  ...
  lazy val cassandraDriverNettyEpoll    = "io.netty"                      %     "netty-transport-native-epoll"          % "4.0.47.Final" classifier "linux-x86_64"
  ...
  lazy val akkaPersistenceCassandra     = "com.typesafe.akka"             %%    "akka-persistence-cassandra"            % "0.85"
  lazy val akkaPersistenceCassandraTest = "com.typesafe.akka"             %%    "akka-persistence-cassandra-launcher"   % "0.85"                  % Test
